...
public abstract class RootParser {
	...
	/*
	public MiRepresentante getRepresentante(String ExternalId) {
		return mapRepresentantes.get(ExternalId);
	}
	
	public void setRepresentante(MiRepresentante Representante) {
		//logger.info("Registro" + Representante.getRegistro__c() );
		mapRepresentantes.put(Representante.getRegistro__c(), Representante);
	}
	*/
