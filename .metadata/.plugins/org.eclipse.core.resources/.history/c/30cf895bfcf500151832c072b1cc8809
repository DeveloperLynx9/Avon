...
public class Contract  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    /**
     * Gets the shippingAddress value for this Contract.
     * 
    ...
    /**
     * Sets the shippingAddress value for this Contract.
     * 
    ...
    /**
     * Gets the shippingGeocodeAccuracy value for this Contract.
     * 
    ...
    /**
     * Sets the shippingGeocodeAccuracy value for this Contract.
     * 
