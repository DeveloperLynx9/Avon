...
public class Opportunity  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    public Opportunity(
           ...
           java.lang.Boolean hasOpenActivity,
           java.lang.Boolean hasOpportunityLineItem,
           java.lang.Boolean hasOverdueTask,
    ...
    /**
     * Gets the hasOpenActivity value for this Opportunity.
     * 
    ...
    /**
     * Sets the hasOpenActivity value for this Opportunity.
     * 
     * @param hasOpenActivity
     */
    ...
    /**
     * Gets the hasOverdueTask value for this Opportunity.
     * 
    ...
    /**
     * Sets the hasOverdueTask value for this Opportunity.
     * 
     * @param hasOverdueTask
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.hasOpenActivity==null && other.getHasOpenActivity()==null) || 
             (this.hasOpenActivity!=null &&
              this.hasOpenActivity.equals(other.getHasOpenActivity()))) &&
            ...
            ((this.hasOverdueTask==null && other.getHasOverdueTask()==null) || 
             (this.hasOverdueTask!=null &&
              this.hasOverdueTask.equals(other.getHasOverdueTask()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getHasOpenActivity() != null) {
            _hashCode += getHasOpenActivity().hashCode();
        }
        if (getHasOpportunityLineItem() != null) {
            _hashCode += getHasOpportunityLineItem().hashCode();
        }
        if (getHasOverdueTask() != null) {
            _hashCode += getHasOverdueTask().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hasOpenActivity");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "HasOpenActivity"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hasOverdueTask");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "HasOverdueTask"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
