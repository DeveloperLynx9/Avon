...
public class UserLicense  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    public UserLicense(
           ...
           com.sforce.soap.enterprise.QueryResult userlicenses) {
        super(
            fieldsToNull,
            id);
    ...
    /**
     * Gets the userlicenses value for this UserLicense.
     * 
     * @return userlicenses
     */
    ...
    /**
     * Sets the userlicenses value for this UserLicense.
     * 
     * @param userlicenses
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.userlicenses==null && other.getUserlicenses()==null) || 
             (this.userlicenses!=null &&
              this.userlicenses.equals(other.getUserlicenses())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getUserlicenses() != null) {
            _hashCode += getUserlicenses().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userlicenses");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "userlicenses"));
