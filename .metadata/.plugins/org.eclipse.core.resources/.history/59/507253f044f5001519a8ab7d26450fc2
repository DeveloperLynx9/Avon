...
public class ContentVersion  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    /**
     * Gets the language value for this ContentVersion.
     * 
     * @return language
     */
    ...
    /**
     * Sets the language value for this ContentVersion.
     * 
     * @param language
     */
    ...
    /**
     * Gets the networkId value for this ContentVersion.
     * 
     * @return networkId
     */
    ...
    /**
     * Sets the networkId value for this ContentVersion.
     * 
     * @param networkId
     */
