...
public class ProcessInstanceWorkitem  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    /**
     * Gets the elapsedTimeInDays value for this ProcessInstanceWorkitem.
     * 
    ...
    /**
     * Sets the elapsedTimeInDays value for this ProcessInstanceWorkitem.
     * 
    ...
    /**
     * Gets the elapsedTimeInHours value for this ProcessInstanceWorkitem.
     * 
    ...
    /**
     * Sets the elapsedTimeInHours value for this ProcessInstanceWorkitem.
     * 
    ...
    /**
     * Gets the elapsedTimeInMinutes value for this ProcessInstanceWorkitem.
     * 
    ...
    /**
     * Sets the elapsedTimeInMinutes value for this ProcessInstanceWorkitem.
     * 
